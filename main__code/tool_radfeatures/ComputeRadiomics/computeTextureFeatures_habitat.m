function [resultsStruct] = computeTextureFeatures_habitat(volObjImage,roiObj_Int,roiObj_Morph,scaleText,algo,grayLevels,userSetMinVal,distCorrection,filterType)
% -------------------------------------------------------------------------
% AUTHOR(S): 
