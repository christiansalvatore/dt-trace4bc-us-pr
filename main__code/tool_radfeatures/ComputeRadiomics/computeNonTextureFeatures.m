function [resultsStruct] = computeNonTextureFeatures(volObjImage,roiObj_Int,roiObj_Morph,scaleNonText,intensity,range,userSetMinVal,IH,IVH,is3D,filterType)
% -------------------------------------------------------------------------
% AUTHOR(S): 
