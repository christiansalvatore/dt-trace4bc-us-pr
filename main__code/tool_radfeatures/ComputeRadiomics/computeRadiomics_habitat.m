function [radiomics,scaleName] = computeRadiomics_habitat(volObjInit,roiObjInit,imParamScan,boxString)
% -------------------------------------------------------------------------
% AUTHOR(S): 
    ...
    try
        ...
        for a = 1:nAlgo
            for n = 1:nGl
                ...
                [imageStruct] = computeTextureFeatures_habitat(volObj,roiObj_Int,roiObj_Morph,scaleText{s},algo{a},grayLevels{a}(n),userSetMinVal,distCorrection);
                for t = 1:nTextTypes
