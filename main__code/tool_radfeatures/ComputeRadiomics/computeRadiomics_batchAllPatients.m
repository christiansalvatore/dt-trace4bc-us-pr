...
for r = 1:nROItypes
    ...
    for i = 1:nBatch
        ...
        if ispc
            ...
            computeRadiomics_AllPatients(pathRead,pathSave,'DICOM_IBSI__Lung-IBSI-001.CTscan.mat',nameROI(patients{i}),nameSet(patients{i}),imParams,roiType,roiType_label)
        else
